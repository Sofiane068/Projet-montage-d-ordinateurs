...
$piece = "INSERT INTO pieces (nom,prix,categorie,marque,quantite,nbDeModeleCreer,dateAjout,compatiblePortable_) VALUES 
    ('ASUS PRIME B450',88.64,'carte_mere','ASUS',10,5,'2020-04-26',0),
    ('Gigabyte B450 Aorus Elite',94.99,'carte_mere','Gigabyte',6,3,'2021-01-04',0),
    ('MSI B450 Gaming Plus Max',87.79,'carte_mere','MSI',0,2,'2021-06-25',1),
    ('ROG STRIX B550-F GAMING',201.95,'carte_mere','ROG',5,3,'2021-11-10',0),
    ('AMD RYZEN 5',144.99,'processeur','AMD',7,3,'2021-08-11',1),
    ('AMD RYZEN 7',319.99,'processeur','AMD',4,2,'2022-01-11',1),
    ('Intel Core i3',94.96,'processeur','INTEL',0,2,'2020-09-21',1),
    ('Intel Core i5',159.96,'processeur','INTEL',3,0,'2020-11-30',1),
    ('Intel Core i7',457.00,'processeur','INTEL',5,4,'2020-12-15',1),
    ('Mémoire RAM Corsair',42.90,'memoire_vive','CORSAIR',7,4,'2021-07-05',0),
    ('Mémoire RAM Crucial',77.00,'memoire_vive','CRUCIAL',0,0,'2021-04-04',1),
    ('Mémoire RAM Kingston',234.08,'memoire_vive','KINGSTON',5,3,'2021-02-27',0),
    ('Mémoire RAM Novatech',12.39,'memoire_vive','NOVATECH',3,3,'2021-01-01',1),
    ('Mémoire RAM Juhor',164.43,'memoire_vive','JUHOR',8,2,'2021-06-22',0),
    ('MSI GeForce RTX 3060 Ti',869.99,'carte_graphique','NVIDIA',4,0,'2021-03-08',0),
    ('Gigabyte Radeon RX 6500 XT',359.99,'carte_graphique','AMD',0,1,'2021-06-12',0),
    ('Gigabyte GeForce RTX 2060',599.99,'carte_graphique','NVIDIA',6,0,'2021-01-01',0),
    ('Carte graphique GTX 970M',158.74,'carte_graphique','NVIDIA',3,1,'2021-10-02',1),
    ('Carte graphique AMD M92',11.64,'carte_graphique','AMD',1,1,'2021-01-23',1),
    ...
    ('Clavier Razer BlackWidow V3',109.99,'clavier','RAZER',0,0,'2021-07-11',0),
    ('Clavier MSI Vigor',34.99,'clavier','MSI',8,2,'2021-01-04',0),
    ('Souris Gaming Logitech G203',26.59,'souris_pad','LOGITECH',6,3,'2021-07-14',1),
    ('Souris Razer Basilisk X ',69.90,'souris_pad','RAZER',4,1,'2021-03-03',1),
    ('Souris Gaming sans fil LOGITEC',167.99,'souris_pad','LOGITEC',3,3,'2021-11-09',1),
    ('Souris Corsair Scimitar ELITE RGB ',69.95,'souris_pad','CORSAIR',6,1,'2021-10-01',1),
    ('Souris Microsoft NGX 00012 Pro',83.46,'souris_pad','MICROSOFT',5,0,'2021-07-12',1),
    ('Ecran PC OPTIX G24C6',189.90,'ecran','MSI',6,3,'2021-08-03',0),
    ('Ecran AOC C27G2ZE Adaptive Sync ',254.99,'ecran','AOC',0,1,'2021-02-07',0),
    ('Ecran PC SAMSUNG ODYSSEY G9 49',1399.00,'ecran','SAMSUNG',5,0,'2021-06-06',0),
    ('Ecran PC Gamer Asus TUF VG247Q1A',199.00,'ecran','ASUS',2,0,'2021-08-21',0),
    ...
    ('Alimentation Thermaltake LitePower 550W',38.99, 'alimentation', 'Thermaltake',0,1,'2021-11-11',0),
    ('Alimentation EVGA 100-W1-0600-K2',56.37, 'alimentation','EVGA',6,0,'2021-04-13',0),
    ...
    ('Samsung Disque SSD 870 QVO 1To',99.99,'disque_dur__ssd','SAMSUNG',4,0,'2021-12-10',0),
    ('SanDisk SSD Plus',78.99, 'disque_dur__ssd', 'SanDisk',5,2,'2021-04-21',0),
    ('Crucial 500Go CT500MX500SSD1 SSD',54.99, 'disque_dur__ssd','CRUCIAL',3,0,'2021-06-17',0),
    ('Seagate 8To BARRACUDA 3.5',209.99, 'disque_dur__ssd','SEAGATE',0,2,'2021-10-03',0),
    ('Toshiba – Disque dur interne',19.99, 'disque_dur__ssd','TOSHIBA',4,2,'2021-02-14',0)";
